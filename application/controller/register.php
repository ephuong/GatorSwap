...
class Register extends Controller
{
    ...
    public function addUser()
	{
	  ...
	  $this->UserModel->setUser($_POST["firstname"], $_POST["lastname"],$_POST['country'],$_POST['state'],$_POST["address"],$_POST["city"],$_POST["zipcode"],$_POST["phoneNumber"], $newly_registered_account_id);
