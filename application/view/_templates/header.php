      ...
      <div class="navbar-collapse collapse" id="myNavbar" style=" margin-top:20px;">
              ...
              <li>
                <div class="input-group">
                  ...
                  <div class="input-group-btn">
                    <button class="btn btn-success-outline" id="search-button" name="search" value="Search"><i class="glyphicon glyphicon-search"></i></button>
                  </div>
                </div>
              </li>
            </ul>
        ...
        <div class = "col-xs-12 col-md-12" style = "padding-top:5px;">
          <ul class="nav navbar-nav navbar-right ">  
            ...
            <li id="sellLink2">
              <a class="btn btn-block btn-primary headerLinks" href="<?php echo URL; ?>sell/index" role="button" style="padding-top:6px;padding-bottom:6px;"><span class="glyphicon glyphicon-open headerLinks" style="font-size:1.5em;"></span> Sell An Item</a>
            </li>
            ...
            <li id="profileLink">
              <a href="<?php echo URL; ?>profile/index" class="headerLinks"><span class="glyphicon glyphicon-user headerLinks"></span>
