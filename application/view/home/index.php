      ...
      <div class="panel panel-primary">
        ...
        <form action="<?php echo URL; ?>home/search" method="POST">
            ...
            <div class="panel-body" style="height:300px">
                ...
                <img class="img-responsive" src="<?php echo URL; ?>public/img/book-icon-white.png"  alt="Image" style="height:100%;" >
            </div></p>
        </form>
      </div>
    </div>
      ...
      <div class="panel panel-primary">
        ...
        <form action="<?php echo URL; ?>home/search" method="POST">
          ...
          <div class="panel-body" style="height:300px">
            <p style="text-align:center;height:100%">
            <button class="btn btn-success-outline" id="category-icons" name="search" style="height:100%;">
            <img class="img-responsive" src="<?php echo URL; ?>public/img/office-icon-white.png"  alt="Image" style="height:100%;"></button>
          </div></p>
        </form>
      </div>
    </div>
      ...
      <div class="panel panel-primary">
        ...
        <form action="<?php echo URL; ?>home/search" method="POST">
          ...
          <div class="panel-body" style="height:300px">
            <p style="text-align:center;height:100%">
            <button class="btn btn-success-outline" id="category-icons" name="search" style="height:100%;">
            <img class="img-responsive" src="<?php echo URL; ?>public/img/furniture-icon-white.png"  alt="Image" style="height:100%;">
          </div></p>
        </form>
      </div>
    </div>
      ...
      <div class="panel panel-primary">
        ...
        <form action="<?php echo URL; ?>home/search" method="POST">
          ...
          <div class="panel-body" style="height:300px">
            <p style="text-align:center;height:100%">
            <button class="btn btn-success-outline" id="category-icons" name="search" style="height:100%;">
            <img class="img-responsive" src="<?php echo URL; ?>public/img/electronic-icon-white.png"  alt="Image" style="height:100%;"></button>
          </div></p>
        </form>
      </div>
    </div>
      ...
      <div class="panel panel-primary">
        ...
        <form action="<?php echo URL; ?>home/search" method="POST">
            ...
            <div class="panel-body" style="height:300px">
              <p style="text-align:center;height:100%">
              <button class="btn btn-success-outline" id="category-icons" name="search" style="height:100%;">
              <img class="img-responsive" src="<?php echo URL; ?>public/img/other-icon-white.png" alt="Image" style="height:100%;"></button>
            </div></p>
      </div>
        </form>
    </div>
